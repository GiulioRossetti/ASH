...
class SWalksCase(unittest.TestCase):
    ...
    def test_shortest_s_walk(self):
        ...
        self.assertDictEqual(s_w, {'e1': ['e1'], 'e3': ['e1', 'e3'], 'e4': ['e1', 'e4'], 'e2': ['e1', 'e3', 'e2'], 'e5': ['e1', 'e3', 'e5']})

        s_w = shortest_s_walk(a, 2)
        self.assertDictEqual(s_w, {
            'e1': {'e1': ['e1'], 'e3': ['e1', 'e3'], 'e4': ['e1', 'e4'], 'e2': ['e1', 'e3', 'e2'],
                   'e5': ['e1', 'e3', 'e5']},
            'e3': {'e3': ['e3'], 'e1': ['e3', 'e1'], 'e2': ['e3', 'e2'], 'e4': ['e3', 'e4'], 'e5': ['e3', 'e5']},
            'e4': {'e4': ['e4'], 'e1': ['e4', 'e1'], 'e2': ['e4', 'e2'], 'e3': ['e4', 'e3'], 'e5': ['e4', 'e5']},
            'e2': {'e2': ['e2'], 'e3': ['e2', 'e3'], 'e4': ['e2', 'e4'], 'e1': ['e2', 'e3', 'e1'],
                   'e5': ['e2', 'e3', 'e5']},
            'e5': {'e5': ['e5'], 'e3': ['e5', 'e3'], 'e4': ['e5', 'e4'], 'e1': ['e5', 'e3', 'e1'],
                   'e2': ['e5', 'e3', 'e2']}})

        s_w = shortest_s_walk(a, 3)
        self.assertDictEqual(s_w, {'e1': {'e1': ['e1'], 'e3': ['e1', 'e3'], 'e4': ['e1', 'e3', 'e4']},
    ...
    def test_s_distance(self):
        ...
        self.assertDictEqual(s_distance(a, 2, 'e1'), {'e1': 0, 'e2': 2, 'e3': 1, 'e4': 1, 'e5': 2})
        self.assertDictEqual(s_distance(a, 2, 'e1', weight=True), {'e1': 0, 'e2': 4, 'e3': 3, 'e4': 2, 'e5': 4})

        self.assertListEqual(list(s_distance(a, 2)), [('e1', {'e1': 0, 'e2': 2, 'e3': 1, 'e4': 1, 'e5': 2}),
    ...
    def test_node_shortest_s_walk(self):
        ...
        self.assertDictEqual(s_w, {1: [1, 2, 3, 4], 2: [2, 1, 3, 4], 3: [3, 1, 2, 4], 4: [4, 1, 3, 2]})
    ...
    def test_node_s_distance(self):
        ...
        self.assertDictEqual(node_s_distance(a, 2, 1, weight=True), {1: 0, 2: 2, 3: 3, 4: 3})

        self.assertListEqual(list(node_s_distance(a, 2)),
                         [(1, {1: 0, 4: 1, 3: 1, 2: 1}), (2, {2: 0, 1: 1, 3: 1, 4: 2}), (3, {3: 0, 1: 1, 4: 1, 2: 1}),
                          (4, {4: 0, 1: 1, 3: 1, 2: 2})])
    ...
    def test_node_average_s_distance(self):
        ...
        self.assertEqual(average_node_s_distance(a, 2, start=0, end=0), 1.3333333333333333)
