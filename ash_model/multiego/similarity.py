...
def jaccard_similarity(multiego1: List[Set[int]], multiego2: List[Set[int]]) -> float:
    ...
    Parameters
    ----------
    multiego1 : List[Set[int]]
        First Multi-Ego Network (list of hyperedges as sets of node IDs).
    multiego2 : List[Set[int]]
        Second Multi-Ego Network (list of hyperedges as sets of node IDs).
...
def minimum_overlapping_similarity(multiego1: List[Set[int]], multiego2: List[Set[int]]) -> float:
    """
