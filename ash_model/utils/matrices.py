...
def _build_incidence_matrix(h: ASH, node_to_index: Dict[int, int], he_to_index: Dict[int, int], start: int = None, end: int = None) -> sparse.csr_matrix:
    """
...
def incidence_matrix(h: ASH, start: int = None, end: int = None, return_mapping: bool = False) -> Union[sparse.csr_matrix, Tuple[sparse.csr_matrix, Dict[int, int], Dict[str, int]]]:
    """    
...
def incidence_matrix_by_time(h: ASH, return_mapping: bool = False) -> Union[Dict[int, sparse.csr_matrix], Tuple[Dict[int, sparse.csr_matrix], Dict[int, int], Dict[str, int]]]:
    """
    ...
    for t in h.temporal_snapshots_ids():
        incidence = _build_incidence_matrix(h, node_to_index, he_to_index, start=t, end=t)
...
def adjacency_matrix(h: ASH, start: int = None, end: int = None, return_mapping: bool = False) -> Union[sparse.csr_matrix, Tuple[sparse.csr_matrix, Dict[int, int]]]:
    """
...
def adjacency_matrix_by_time(h: ASH, return_mapping: bool = False) -> Union[Dict[int, sparse.csr_matrix], Tuple[Dict[int, sparse.csr_matrix], Dict[int, int]]]:
    """
