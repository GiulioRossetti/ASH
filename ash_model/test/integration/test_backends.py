...
class BackendIntegrationTestCase(unittest.TestCase):
    ...
    def test_identical_node_operations(self):
        ...
        self.assertEqual(h_dense.number_of_nodes(), h_interval.number_of_nodes())
    ...
    def test_identical_hyperedge_operations(self):
        ...
        self.assertEqual(set(h_dense.hyperedges()), set(h_interval.hyperedges()))
        self.assertEqual(
    ...
    def test_identical_temporal_queries(self):
        ...
        self.assertEqual(
            h_dense.temporal_snapshots_ids(), h_interval.temporal_snapshots_ids()
        )
    ...
    def test_identical_node_presence(self):
        ...
        self.assertEqual(h_dense.node_presence(1), h_interval.node_presence(1))
    ...
    def test_identical_degree_calculations(self):
        ...
        for node in [1, 2, 3, 4]:
            self.assertEqual(
                h_dense.degree(node, start=0), h_interval.degree(node, start=0)
            )
    ...
    def test_identical_star_operations(self):
        ...
        for node in [1, 2, 3, 4]:
            self.assertEqual(
                set(h_dense.star(node, start=0)), set(h_interval.star(node, start=0))
            )
    ...
    def test_identical_with_attributes(self):
        ...
        # Check attributes
        self.assertEqual(
            h_dense.get_node_attributes(1), h_interval.get_node_attributes(1)
        )
