...
class HyperSegregationTestCase(unittest.TestCase):
    ...
    def test_rwhs_meet_basic(self):
        ...
        scores = rwhs(self.h, s=1, tid=0, num_walks=10, walk_length=5, method="meet")
    ...
    def test_rwhs_jump_basic(self):
        ...
        scores = rwhs(self.h, s=1, tid=0, num_walks=10, walk_length=5, method="jump")
    ...
    def test_rwhs_invalid_method_raises(self):
        ...
        with self.assertRaises(ValueError):
            rwhs(self.h, s=1, tid=0, method="invalid")
    ...
    def test_rwhs_homogeneous_vs_heterogeneous(self):
        ...
        scores_homo = rwhs(
            h_homo, s=1, tid=0, num_walks=50, walk_length=10, method="meet"
        )
        scores_hetero = rwhs(
            h_hetero, s=1, tid=0, num_walks=50, walk_length=10, method="meet"
        )
    ...
    def test_temporal_rwhs_basic(self):
        ...
        scores = temporal_rwhs(
            h, s=1, tid=0, num_walks=10, walk_length=5, method="meet"
        )
    ...
    def test_temporal_rwhs_jump_method(self):
        ...
        scores = temporal_rwhs(
            h, s=1, tid=0, num_walks=10, walk_length=5, method="jump"
        )
    ...
    def test_rwhs_empty_walks(self):
        ...
        scores = rwhs(h, s=1, tid=0, num_walks=10, walk_length=5, method="meet")
